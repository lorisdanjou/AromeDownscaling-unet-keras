...
output_dir = '/cnrm/recyf/Data/users/danjoul/unet_experiments/normalisations/normalisations_config/'
...
root_dir = output_dir
expes = pd.DataFrame(
    {'name' : ['std', 'std both X', 'std both y'],
    'dir' : [
    root_dir + 'standardisation/',
    root_dir + 'standardisation_both/',
    root_dir + 'standardisation_both_y/'
    ]}
)
