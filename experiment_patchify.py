...
patch_size = 128
output_dir = '/cnrm/recyf/Data/users/danjoul/unet_experiments/patchify/128/'
...
Model definition
"""
unet = unet_maker_manu_r((None, None, X_train.shape[3]))
...
print('len y pred : ', len(y_pred_df))
print('len y test : ', len(y_test_df))
...
print('y_pred shape : ', y_pred_df.t2m[0].shape)
