...
working_dir = '/cnrm/recyf/Data/users/danjoul/unet_experiments/wind/'


# ========== Load Data
results_df_u = load_results(working_dir, dates_test, echeances, resample, data_test_location, baseline_location, param='u10')
results_df_v = load_results(working_dir, dates_test, echeances, resample, data_test_location, baseline_location, param='v10')
