...
output_dir = '/cnrm/recyf/Data/users/danjoul/unet_experiments/unet_4/0.005_32_100/cosine_similarity/'
...
unet.compile(optimizer=Adam(lr=LR), loss=CosineSimilarity(axis=0), metrics=[rmse_k])  
